...
{
    /// <inheritdoc />
    public partial class DBMOne : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountCreatedDate = table.Column<DateTime>(type: "date", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogUserActivity", x => x.LogId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReturnDeadline = table.Column<DateTime>(type: "date", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Borrowed", x => x.BorrowId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    ApplicationTimestamp = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ExpectedAvailabilityDate = table.Column<DateTime>(type: "date", nullable: true),
                    ReservationExpiryDate = table.Column<DateTime>(type: "date", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinePaidStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LogUserActivity_UserId",
